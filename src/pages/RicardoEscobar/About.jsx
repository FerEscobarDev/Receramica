        ...
        <>
            ...
            <div className="main">
                ...
                <Container>
                    ...
                    <h2 className="text-center creators">El Arte de la Cerámica</h2>
                    <Row>
                        <Col md="4">
                            <div className="info">
                                {/* <div className="icon">
                                ...
                                <div className="description">
                                    <h4 className="info-title">La Técnica</h4>
                                    <p>
                        ...
                        <Col md="4">
                            <div className="info">
                                ...
                                <div className="description">
                                    <h4 className="info-title">El Taller</h4>
                                    <p>
                        ...
                        <Col md="4">
                            <div className="info">
                                ...
                                <div className="description">
                                    <h4 className="info-title">El Barro</h4>
                                    <p>
                    ...
                    <Row>
                        ...
                        <Col md="12">
                            <Card className="card-profile ">
                                <CardBody>
                                    ...
                                    <CardTitle tag="h4">La Técnica</CardTitle>
                        ...
                        <Col md="6">
                            <Card className="card-profile ">
                                <CardBody>
                                    <CardTitle tag="h4">El Taller</CardTitle>
                        ...
                        <Col md="6">
                            <Card className="card-profile ">
                                <CardBody>
                                    <CardTitle tag="h4">El Barro</CardTitle>
